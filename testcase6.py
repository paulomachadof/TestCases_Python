# Test Case ID = ID_006
# Test Case Description: Verificar se a funcionalidade "Esqueceu sua senha" reconhece email não cadastrado.
#autor: paulomachado
...
class TestFunc(unittest.TestCase):
    ...
    def test_func(self):
        ...
        search_field.send_keys("emailnaocadastrado@email.com")
