# Test Case ID = ID_007
# Test Case Description: Completar Perfil com dados invalidos ou em branco.
#autor: paulomachado
...
class TestComoApoiar(unittest.TestCase):
    ...
    def test_como_apoiar(self):
        ...
        driver.find_element_by_xpath("/html/body/div/div[2]/section/div/div/div[2]/form/div[2]/button").click()
