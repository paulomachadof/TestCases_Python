# Test Case ID = ID_0012
# Test Case Description: Adicionar "Cargo Atual ou Pleiteado no Hapvida" com dados invalidos ou em branco.
#autor: paulomachado
...
class TestFunc(unittest.TestCase):
    ...
    def test_func(self):
        ...
        driver.find_element_by_xpath("/html/body/div/div[2]/section/div/div/div[7]/div[1]/div/a").click()
