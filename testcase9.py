# Test Case ID = ID_009
# Test Case Description: Adicionar "Titulo" com dados invalidos ou em branco.
#autor: paulomachado
...
class TestFunc(unittest.TestCase):
    ...
    def test_func(self):
        ...
        driver.find_element_by_xpath("/html/body/div/div[2]/section/div/div/div[4]/div[1]/div/a").click()
